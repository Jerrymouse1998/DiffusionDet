...
if __name__ == '__main__':
    generate_json_labels('../../datasets/HRSC2016',
                         "../HRSC2016/ImageSets/trainval.txt")
    generate_json_labels('../../datasets/HRSC2016',
                         "../HRSC2016/ImageSets/test.txt")
    generate_json_labels('../../datasets/HRSC2016',
                         "../HRSC2016/ImageSets/train.txt")
    generate_json_labels('../../datasets/HRSC2016',
                         "../HRSC2016/ImageSets/val.txt")
    print('done!')
